# Reusable Materials | Matériel réutilisable
...
This folder contains reusable material connected to the public gallery cards, plus optional supporting templates prepared for the workshop.

Each file is meant to be adapted before classroom use. Please check disciplinary accuracy, privacy constraints, assessment rules, and local institutional expectations before using any material with students.

Linked from current gallery cards:
...
Ce dossier contient le matériel réutilisable lié aux cartes de la galerie publique, ainsi que des modèles complémentaires préparés pour l'atelier.

Chaque fichier doit être adapté avant un usage en classe. Merci de vérifier l'exactitude disciplinaire, les contraintes de confidentialité, les règles d'évaluation et les attentes institutionnelles locales avant toute utilisation avec des étudiants.

Lié aux cartes actuelles de la galerie:
